...
export async function GET(request: Request) {
  try {
    ...
    // Set default salesstatus if neither status nor salesstatus provided
    if (!searchParams.get('salesstatus') && !searchParams.get('status')) {
      url.searchParams.set('salesstatus', 'active');
    }
