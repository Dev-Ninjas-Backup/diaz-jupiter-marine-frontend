...
import { FaAnchor, FaArrowLeft, FaHome, FaSearch } from 'react-icons/fa';
...
const BoatNotFound = ({ error }: BoatNotFoundProps) => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-slate-50 to-blue-50 flex flex-col items-center justify-center px-4">
      {/* Animated boat icon */}
