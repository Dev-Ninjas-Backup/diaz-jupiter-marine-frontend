...
import { getAllYBListings, applyYBFilters, YBBoat, YBFilterParams } from '@/services/boats/yachtbroker';
...
const AllListing = ({ filters }: { filters?: YBFilterParams }) => {
  ...
  const pageItems = filtered.slice((page - 1) * perPage, page * perPage).map(mapYBBoat);
